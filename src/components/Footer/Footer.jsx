        ...
        <div className="footer__body">
          ...
          <nav className="footer__nav">
            ...
            <ul className="footer__contacts">
              <li className="footer__item text text_size_normal">
                {" "}
                Общие вопросы <br /> info @infinity.network{" "}
              </li>
              <li className="footer__item text text_size_normal">
                Партнерство/листинг <br />
                partnership @infinity.network
              </li>
              <li className="footer__item text text_size_normal">
                PR & Маркетинг <br /> pr @infinity.network
              </li>
            </ul>
          </nav>
          <div className="wrapper">
            ...
            <p className="footer__status text text_size_small">
              Статус mainnet:{" "}
              <span className="footer__status footer__status_active">
                активен
              </span>
            </p>
          </div>
