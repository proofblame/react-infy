        ...
        <div className={modalActive.info ? `modal-new active` : `modal-new`}>
          ...
          <div className="modal-body-new">
            <p className="text text_size_medium text_color_normal">
              Заработок по уровням в партнерской программе при оплате тарифа
              (оплата тарифа составляет 490 рублей): <br />
              <br />
              1 уровень: 30% с оплаты тарифа;
              <br />
              2 уровень: 25% с оплаты тарифа;
              <br />
              3 уровень: 20% с оплаты тарифа;
              <br />
              4 уровень: 15% с оплаты тарифа;
              <br />
              5 уровень: 10% с оплаты тарифа.
              <br />
              <br />
              (В общей сложности все 100% от оплаты тарифов будет распределяться
              в качестве вознаграждений партнерской сети до 5 уровней в
              глубину).
              <br />
              Заработок по уровням в партнерской программе (награждение с
              делегирования приглашенных):
              <br />
              <br />
              Заработок по уровням:
              <br />
              1 уровень: 5% от делегируемой суммы;
              <br />
              2 уровень: 4% от делегируемой суммы;
              <br />
              3 уровень: 3% от делегируемой суммы;
              <br />
              4 уровень: 2% от делегируемой суммы;
              <br />
              5 уровень: 1% от делегируемой суммы.
              <br />
              <br />
              В общей сложности взимается только 5%, которые распределятся 1
              уровню в качестве вознаграждений по партнерской программе. А
              вознаграждения 2, 3, 4 и 5 уровней сервис распределяет
              автоматически (вознаграждение от компании). <br />
              <br />
              Итого 15% распределятся по уровням, а 10% из них сервис начисляет
              автоматически за активность (% от зарегистрированных
              пользователей, без приглашения).
            </p>
          </div>
        </div>
      </div>
